...
The density plot shows a multimodal distribution even though the distribution is quite a decreasing distribution after the first mode.
...
Since we have a positive skewness coefficient we confirm that the distribution of the masses recorded in NGC661 have a right tail, this means that the mass of the distribution is concentrated on the left of our density. Therefore, perhaps the median should be better than the mean as an index of centrality. The kurtosis coefficient is negative, this means that the tails are thin ("_platykurtic_" distribution).
