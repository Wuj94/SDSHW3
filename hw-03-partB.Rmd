...
Now, we can try to overlay the histogram plot using a lognormal density with the point estimates for location (-1.255) and scale (1.032). 

```{r, fig.align="center", fig.width=10}

hist(df$Mass, probability = T, breaks = 40, col = rgb(0,.55,.9,.8),
     main = "Histogram of the masses", xlab = "Mass")

lines(seq(0,1.5,0.01), dlnorm(seq(0,1.5,0.01), -1.255,1.032), lwd = 3,
      col = "orange")
legend("topright", legend = c("logNormal~(-1.255,1.032)"), 
       lwd = 3, col = "orange")
```
